...
const Hero = () => {
  ...
  return (
    <section id="Home" className={` h-screen flex mx-auto text-center ${styles.interWidth}`}>
      ...
      <div className={`xl:w-2/3 sm:w-3/4 w-full flex-col items-center self-center z-20`}>
          ...
          <p className= {`${styles.xPaddings} font-light sm:text-left text-center 2xl:text-2xl xl:text-xl md:text-xl sm:text-lg text-md text-secondary-white`}>
          ...
          <div className="flex flex-row justify-center sm:justify-start gap-2">
            <div className='2xl:pl-0 px-6 sm:pr-8 sm:mt-8 md:mt-10 mt-5'>
                <button className="border-[1px] border-white border-opacity-20 shadow hover:shadow-md hover:bg-white hover:bg-opacity-5 text-off-white py-2 px-6 items-center flex flex-row rounded-md duration-500">
                  <a className={` text-sm sm:text-l md:text-xl font-normal hover:text-white duration-400 cursor-pointer`} href="https://twitter.com/bridgrxyz">
            ...
            <div className='sm:mt-8 md:mt-10 mt-5'>
                <button className='border-[1px] border-white border-opacity-20 shadow hover:shadow-md hover:bg-white hover:bg-opacity-5 text-off-white py-2 px-5 items-center flex flex-row rounded-md duration-500'>
                  <a className={` text-sm sm:text-l md:text-xl font-normal hover:text-white duration-400 cursor-pointer`} href="#Contact">
      ...
      <div className={`xl:1/3 sm:w-1/4 mx-auto my-auto`}>
        ...
        {/* <div className='w-[2px] h-[460px] sm:block hidden rounded-2xl my-auto bg-white bg-opacity-30 mr-12' /> */}
          ...
          <div className="flex sm:flex-col items-center justify-center xl:gap-14 lg:gap-12 md:gap-14 sm:gap-14 gap-6 flex-row my-auto strip-gradient sm:h-screen 2xl:px-16 xl:px-14 lg:px-10 md:px-8 px-6 py-0">
            <div className=''>
