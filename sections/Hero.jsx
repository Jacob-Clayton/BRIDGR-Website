        ...
        <div>
          ...
          <motion.p
            ...
            <div className='flex flex-row justify-center sm:justify-start'>
              ...
              >
                  <button className='border-[2px] border-white border-opacity-20 shadow-md hover:bg-blue-800 hover:bg-opacity-60 text-off-white py-2 px-6 items-center flex flex-row rounded-2xl duration-500'>
                    <a className= "text-sm sm:text-l md:text-xl font-medium hover:text-white duration-400 cursor-pointer " href="https://t.me/bridgr">
                      Join us</a><Image src="/telegram.svg" className="sm:w-[22px] sm:h-[22px] w-[18px] h-[18px] ml-4" width={20} height={20} />
                  </button>
              </motion.div>
              <motion.div 
                variants={fadeIn('up', 'tween', 0.2, 1)}
              ...
              >
                  <button className='border-[2px] border-white border-opacity-20 shadow-md hover:bg-blue-800 hover:bg-opacity-60 text-off-white py-2 px-6 items-center flex flex-row rounded-2xl duration-500'>
                    <a className= "text-sm sm:text-l md:text-xl font-medium hover:text-white duration-400 cursor-pointer " href="mailto:bridgrxyz@gmail.com">
                      Contact</a><Image src="/email.svg" className="sm:w-[19px] sm:h-[19px] w-[16px] h-[16px] ml-4" width={20} height={20} />
                  </button>
              </motion.div>
            </div>
          </div>
