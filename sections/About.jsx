  ...
  return (
    <section className={`${styles.paddings} relative z-10 `} id="About" >
      ...
      >
        ...
        >
          The Bridgr collective is made up of Web3 companies from around the world making a formidable collective, working to provide our members with everything needed to become a successful Web3 business.
        </motion.p>
