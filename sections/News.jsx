                    ...
                    <div className="w-full flex justify-between items-center">
                        <div className="flex-1 md:ml-[62px] flex flex-col max-w-[650px]">
                            ...
                            <p className="mt-[16px] font-normal lg:text-[20px] text-[14px] text-secondary-white">
                                We've went tropical and threw a huge red carpet event at the Lighthouse Studios Bali on 
                                <span className='text-white'> 24th Feb 2023.</span>
                            </p>
                        </div>
                ...
                >
                    ...
                    <div className="w-full flex justify-between items-center">
                        <div className="flex-1 md:ml-[62px] flex flex-col max-w-[650px]">
                            ...
                            <p className="mt-[16px] font-normal lg:text-[20px] text-[14px] text-secondary-white">
                                Everyone's favourite NFT bar, The Parlour Singapore, hosted another sold out one of our 'WEB3 SOCIAL' events on 
                                <span className='text-white'> Feb 3rd 2023.</span>
                            </p>
                        </div>
                    ...
                    <div className="w-full flex justify-between items-center">
                        <div className="flex-1 md:ml-[62px] flex flex-col max-w-[650px]">
                            ...
                            <p className="mt-[16px] font-normal lg:text-[20px] text-[14px] text-secondary-white">
                                ...
                                <span className='text-white'> Nov 14th 2022.</span>
                            </p>
                        </div>
