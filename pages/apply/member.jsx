		...
		<>
			...
			<div className={`${styles.paddings} relative bg-primary-lightBlue min-h-screen`}>
				<div className={`${styles.innerWidth} flex flex-col mx-auto mt-5 sm:mt-10 md:mt-20`}>
					...
					<MemberForm/>
					<button className='mx-auto mt-10 border-[1px] border-white border-opacity-30 shadow-md hover:bg-white hover:bg-opacity-10 text-off-white py-1 pl-6 pr-5 items-center flex flex-row rounded-lg duration-500'>
