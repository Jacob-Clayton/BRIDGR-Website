...
const NotFoundPage = () => {
    return (
        <>
        <Navbar />
        <section className={`${styles.paddings} relative bg-primary-lightBlue min-h-screen`}>
                <div className={`${styles.innerWidth} mx-auto mt-5 sm:mt-10 md:mt-20`}>
                    ...
                    <div className='mt-10 flex flex-row gap-6 justify-center'>
                        <button className='border-[1px] border-white border-opacity-30 shadow-md hover:bg-white hover:bg-opacity-10 text-off-white py-1 pl-6 pr-5 items-center rounded-lg duration-500'>
