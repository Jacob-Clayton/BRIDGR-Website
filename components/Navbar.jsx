...
function MobileNav({open, setOpen}) {
  return (   
    <div className={`absolute z-50 top-0 right-0 h-screen 2xl:w-[14%] xl:w-[15%] lg:w-[19%] md:w-[25%] sm:w-[30%] w-[45%] bg-primary-black bg-opacity-[95%] rounded-br-[10px] rounded-tl-[10px] rounded-bl-[10px] transform ${open ? "right-0" : "transform translate-x-full"} transition-transform duration-100 ease-in-out filter  `}>
          ...
          <div className=' fixed top-0 pt-4 z-50 w-full backdrop-blur-sm'>
            <div className='flex justify-between items-center '>
              ...
              <div className='flex justify-end  mr-[2%]'>
                <ul className="lg:flex hidden lg:text-md xl:text-[1.1rem] font-normal text-off-white cursor-pointer">
                    ...
                    <li className="px-3 hover:text-white duration-500">
                      <a href="https://docs.bridgr.xyz" className='flex flex-1'>Whitepaper<img src="/external-link.svg" className="sm:w-[14px] sm:h-[14px] w-[12px] h-[12px] ml-1"/></a>
                    </li>
                </ul>
