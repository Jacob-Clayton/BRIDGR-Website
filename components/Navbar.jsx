...
function MobileNav({open, setOpen}) {
  return (   
    <div className={`absolute z-50 top-0 right-0 h-screen 2xl:w-[14%] xl:w-[15%] lg:w-[19%] md:w-[25%] sm:w-[30%] w-[40%] bg-primary-black bg-opacity-[90%] rounded-br-[10px] rounded-tl-[10px] rounded-bl-[10px] transform ${open ? "right-0" : "transform translate-x-full"} transition-transform duration-100 ease-in-out filter  `}>
    ...
    return (
        ...
        <motion.nav>
          <motion.div 
            ...
            initial="hidden"
            whileInView="show"
            className={`${styles.xPaddings} py-8 relative navbar absolute inset-0`}
          />
          <div className=' fixed top-0 pt-4 z-50 w-full backdrop-blur-sm'>
            <div className='flex justify-between items-center '>
              ...
              <div className='flex justify-end  mr-[2%]'>
                <ul className="lg:flex hidden text-sm lg:text-lg xl:text-xl font-bold text-off-white cursor-pointer">
