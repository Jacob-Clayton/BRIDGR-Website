    ...
    return (
        <>
            <motion.div
                ...
                whileInView="show"
                className={`${styles.innerWidth} ${poppins.variable} flex flex-col md:flex-row justify-center mx-auto md:mt-10 mt-5 xl:gap-12 lg:gap-10 md:gap-6 sm:gap-4 gap-2`}
            >
                <div className="p-1">
                    <div className="bg-[#fafafa] rounded-xl h-full 2xl:w-[330px] xl:w-[320px] lg:w-[280px] md:w-[230px] flex flex-col justify-between shadow-2xl overflow-hidden">
                        <div className="px-2 py-6">
                            <div className="font-normal">
                                <div className=" p-6 sm:px-20 md:px-2 lg:px-6 xl:px-8">
                                    <p className="text-3xl font-medium text-center text-[#379CE0]">Consult</p>
                                    <div class="flex justify-center items-baseline my-8">
                                        <span class="mr-2 text-4xl text-primary-black font-extrabold">$150</span>
                                        <span class={`font-poppins text-gray-400 font-medium`}>/ hour</span>
                                    </div>
                ...
                <div className="p-1">
                    <div className="bg-[#fafafa] rounded-xl h-full 2xl:w-[330px] xl:w-[320px] lg:w-[280px] md:w-[230px] flex flex-col justify-between shadow-2xl overflow-hidden">
                        <div className="px-4 py-6">
                            <div className="font-normal">
                                    <div className="p-6 sm:px-20 md:px-2 lg:px-6 xl:px-8">
                                    <p className="text-3xl font-medium text-center text-[#379CE0]">Friend</p>
                                    <div class="flex justify-center items-baseline my-8">
                                        <span class=" mr-2 text-4xl text-primary-black font-extrabold">$200</span>
                                        <span class={`font-poppins text-gray-400 font-normal`}>/ lifetime</span>
                                    </div>
                                    <p className={`font-poppins text-gray-600 mb-2`}>
                                        <svg className="inline-block w-4 h-4 mr-2 fill-current text-[#379CE0]" viewBox="0 0 30 30">
                ...
                <div className="rounded-2xl magic-border p-1">
                    <div className="relative bg-[#fafafa] rounded-xl h-full 2xl:w-[330px] xl:w-[320px] lg:w-[280px] md:w-[230px] flex flex-col justify-between shadow-2xl overflow-hidden">
                    ...
                    <div class="absolute right-0 top-[163px] magic-border w-full lg:h-[1.5rem] md:h-[1.3rem] h-[1.5rem] flex justify-center items-center text-white font-medium xl:text-[0.91rem] lg:text-[0.85rem] md:text-[0.7rem] sm:text-lg text-[0.81rem] transform skew-y-3">
                        <p className={`font-poppins text-center leading-none`}>Register interest before June for 20% off</p>
                    </div>
                        ...
                        <div className="px-4 py-6">
                            <div className="font-normal text-gray-600">
                                    ...
                                    <div class="flex justify-center items-baseline my-8 relative">
                                        ...
                                        <span class={`font-poppins text-gray-400 font-normal z-10`}>/ year</span>                                    
                                    </div>
